...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontassest/css/all.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontassest/css/all.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontassest/css/lightbox.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontassest/css/flexslider.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontassest/css/owl.carousel.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontassest/css/owl.theme.default.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontassest/css/jquery.rateyo.css') }}" />
    <!-- <link rel="stylesheet" type="text/css" href="css/jquery.mmenu.all.css" /> -->
    <!-- <link rel="stylesheet" type="text/css" href="css/meanmenu.min.css"> -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontassest/css/inner-page-style.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontassest/css/style.css') }}">
    ...
    <div id="page" class="site" itemscope itemtype="http://schema.org/LocalBusiness">
                ...
                <div class="container">
                    <div class="top-header-left">
                        <div class="top-header-block">
                            <a href="mailto:info@QPG.com" itemprop="email"><i class="fas fa-envelope"></i>
                                info@QPG.com</a>
                        </div>
                        <div class="top-header-block">
                            <a href="tel:+921111111" itemprop="telephone"><i class="fas fa-phone"></i> +
                                921111111</a>
                        </div>
                    </div>
            ...
            <div class="main-header">
                <div class="container">
                    <div class="logo-wrap" itemprop="logo">
                        {{-- <img src="{{ asset('frontassest/images/site-logo.jpg') }}" alt="Logo Image"> --}}
                        <!-- <h1>Education</h1> -->
                    </div>
                    <div class="nav-wrap">
        ...
        <div class="banner">
            <div class="owl-four owl-carousel" itemprop="image">
                <img src="{{ asset('frontassest/images/page-banner.jpg') }}" alt="Image of Bannner">
                <img src="{{ asset('frontassest/images/page-banner2.jpg') }}" alt="Image of Bannner">
                <img src="{{ asset('frontassest/images/page-banner3.jpg') }}" alt="Image of Bannner">
            </div>
                    ...
                    <div class="owl-one owl-carousel">
                        <div class="box-wrap" itemprop="event" itemscope itemtype=" http://schema.org/Course">
                            <div class="img-wrap" itemprop="image"><img
                                    src="{{ asset('frontassest/images/course-pic.jpg') }}" alt="courses picture">
                            </div>
                            <a href="#" class="learn-desining-banner" itemprop="name">Learn Web Designing
                                >>></a>
        ...
        <section class="gallery-images-section" itemprop="image" itemscope
            ...
            <div class="gallery-img-wrap">
                <a href="images/gallery-img1.jpg" data-lightbox="example-set"
                    ...
                    <img src="{{ asset('frontassest/images/gallery-img1.jpg') }}" alt="gallery-images">
                </a>
            </div>
            <div class="gallery-img-wrap">
                <a href="images/gallery-img2.jpg" data-lightbox="example-set"
                    data-title="Click the right half of the image to move forward.">
                    <img src="{{ asset('frontassest/images/gallery-img2.jpg') }}" alt="gallery-images">
                </a>
            </div>
            <div class="gallery-img-wrap">
                <a href="images/gallery-img3.jpg" data-lightbox="example-set"
                    data-title="Click the right half of the image to move forward.">
                    <img src="{{ asset('frontassest/images/gallery-img3.jpg') }}" alt="gallery-images">
                </a>
            </div>
            <div class="gallery-img-wrap">
                <a href="images/gallery-img4.jpg" data-lightbox="example-set"
                    data-title="Click the right half of the image to move forward.">
                    <img src="{{ asset('frontassest/images/gallery-img4.jpg') }}" alt="gallery-images">
                </a>
            </div>
            <div class="gallery-img-wrap">
                <a href="images/gallery-img5.jpg" data-lightbox="example-set"
                    data-title="Click the right half of the image to move forward.">
                    <img src="{{ asset('frontassest/images/gallery-img5.jpg') }}" alt="gallery-images">
                </a>
            </div>
            <div class="gallery-img-wrap">
                <a href="images/gallery-img6.jpg" data-lightbox="example-set"
                    data-title="Click the right half of the image to move forward.">
                    <img src="{{ asset('frontassest/images/gallery-img6.jpg') }}" alt="gallery-images">
                </a>
            </div>
            <div class="gallery-img-wrap">
                <a href="images/gallery-img7.jpg" data-lightbox="example-set"
                    data-title="Click the right half of the image to move forward.">
                    <img src="{{ asset('frontassest/images/gallery-img7.jpg') }}" alt="gallery-images">
                </a>
            </div>
            <div class="gallery-img-wrap">
                <a href="images/gallery-img8.jpg" data-lightbox="example-set"
                    data-title="Click the right half of the image to move forward.">
                    <img src="{{ asset('frontassest/images/gallery-img8.jpg') }}" alt="gallery-images">
                </a>
            </div>
            <div class="gallery-img-wrap">
                <a href="images/gallery-img9.jpg" data-lightbox="example-set"
                    data-title="Click the right half of the image to move forward.">
                    <img src="{{ asset('frontassest/images/gallery-img9.jpg') }}" alt="gallery-images">
                </a>
            </div>
            <div class="gallery-img-wrap">
                <a href="images/gallery-img10.jpg" data-lightbox="example-set"
                    data-title="Click the right half of the image to move forward.">
                    <img src="{{ asset('frontassest/images/gallery-img10.jpg') }}" alt="gallery-images">
                </a>
            </div>
            <div class="gallery-img-wrap">
                <a href="images/gallery-img11.jpg" data-lightbox="example-set"
                    data-title="Click the right half of the image to move forward.">
                    <img src="{{ asset('frontassest/images/gallery-img11.jpg') }}" alt="gallery-images">
                </a>
            </div>
            <div class="gallery-img-wrap">
                <a href="images/gallery-img12.jpg" data-lightbox="example-set"
                    data-title="Click the right half of the image to move forward.">
                    <img src="{{ asset('frontassest/images/gallery-img12.jpg') }}" alt="gallery-images">
                </a>
            </div>
        </section>
            ...
            <div class="container">
                <div class="event-wrap">
                    <div class="img-wrap" itemprop="image">
                        <img src="{{ asset('frontassest/images/events.jpg') }}" alt="event images">
                    </div>
                    <div class="details">
                        <a href="">
                            <h3 itemprop="name">Orientation Programme for new Students.</h3>
                        </a>
                        <p itemprop="description">Orientation Programme for new sffs Students. Orientation Programme
                            for
                            new sffs Students. Orientation Programme for new sffs Students.</p>

                        <h5 itemprop="startDate"><i class="far fa-clock"></i> jan 30,2023 | 11am</h5>
                        <h5 itemprop="location"><i class="fas fa-map-marker-alt"></i> test</h5>
                    </div>
                </div>
 ...
 <ul class="slides">
      ...
      <div class="rateYo"></div>
                        ...
                        <div class="border">
                            <div class="customer">
                                <figure>
                                    <img class="customer-img"
                                        src="{{ asset('frontassest/images/customer-img.jpg') }}" alt="Person image">
                                    <figcaption>
                            ...
                            <div class="customer-review">
                                <p itemprop="description">
                                    ...
                                    tempor incididunt ut KPITBoard dolore magna aliqua. Ut enim ad minim veniam,
                ...
                <div class="owl-two owl-carousel">
                    <div class="news-wrap" itemprop="event">
                        <div class="news-img-wrap" itemprop="image">
                            <img src="{{ asset('frontassest/images/latest-new-img.jpg') }}" alt="Latest News Images">
                        </div>
        ...
        <section class="query-section">
            <div class="container">
                <p>Any Queries? Ask us a question at<a href="tel:+9211111111"><i class="fas fa-phone"></i> +
                        9211111111</a></p>
            </div>
        </section>
        ...
        <footer class="page-footer" itemprop="footer" itemscope itemtype="http://schema.org/WPFooter">
            <div class="footer-first-section">
                <div class="container">
                    <div class="box-wrap" itemprop="about">
                        ...
                        <h4><a href="tel:+9779813639131"><i class="fas fa-phone"></i> +9211111111</a></h4>
                        <h4><a href="mailto:info@QPG.com"><i class="fas fa-envelope"></i>
                                info@QPG.com</a></h4>
                        <h4><a href=""><i class="fas fa-map-marker-alt"></i>Test</a></h4>
                    </div>
                    ...
                    <div class="box-wrap">
                        ...
                        <div class="recent-course-wrap">
                            <img src="{{ asset('frontassest/images/ui-ux.jpg') }}" alt="Ui/Ux Designing">
                            <a href="">
            ...
            <div class="footer-last-section">
                <div class="container">
                    <p>Copyright 2023 &copy; QPG.com <span> | </span> Theme designed and developed by <a
                            href="">KPIT Board</a></p>
                </div>
            </div>
        </footer>
   ...
   <ul>
    ...
    <script type="text/javascript" src="{{ asset('frontassest/js/jquery-3.3.1.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('frontassest/js/lightbox.js') }}"></script>
    <script type="text/javascript" src="{{ asset('frontassest/js/all.js') }}"></script>
    <script type="text/javascript" src="{{ asset('frontassest/js/isotope.pkgd.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('frontassest/js/owl.carousel.js') }}"></script>
    <script type="text/javascript" src="{{ asset('frontassest/js/jquery.flexslider.js') }}"></script>
    <script type="text/javascript" src="{{ asset('frontassest/js/jquery.rateyo.js') }}"></script>
    <!-- <script type="text/javascript" src="js/jquery.mmenu.all.js"></script> -->
    <!-- <script type="text/javascript" src="js/jquery.meanmenu.min.js"></script> -->
    <script type="text/javascript" src="{{ asset('frontassest/js/custom.js') }}"></script>
</body>
