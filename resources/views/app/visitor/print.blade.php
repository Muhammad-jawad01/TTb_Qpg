...
<body>
    <div class="ticket">
        <div class="centered">
            {!! QrCode::size(100)->generate(base64_encode($visitor->qrcode??$visitor->id)) !!}
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th colspan="2">{{ UcFirst($visitor->gate->name) }}</th>
                </tr>
                <tr>
    ...
    <a href="{{ route('visitors.create') }}" class="hidden-print">back</a>
    <script>
