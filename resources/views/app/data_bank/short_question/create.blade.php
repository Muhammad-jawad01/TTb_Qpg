                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('shortQuestions.store') }}" method="POST">
                                @csrf
                                        ...
                                        <div class=" row">
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="test" rows="3" cols="50" type="text" name="data[0][question]" id="vehicle_0_name"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <strong>Type:</strong>
                                                    {{-- <input type="text" name="data[0][type]" id="vehicle_0_name"
                                                        class="form-control" data-pattern-name="data[++][type]"
                                                        data-pattern-id="vehicle_++_name" /> --}}

                                                    <select class="form-select form-control" name="data[0][type]"
                                                        data-pattern-name="data[++][type]"
                                                        data-pattern-id="vehicle_++_name">
