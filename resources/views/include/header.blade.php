                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <ul class="list-unstyled megamenu-list">
                                    <li class="font-15 mb-1"><a href="{{ url('/apps/ecommerce/dashboard') }}">
                                            {{ __('Ecommerce') }} </a></li>
                                    <li class="font-15 mb-1"><a href="{{ url('/apps/chat') }}"> {{ __('Chat') }}</a>
                                    </li>
                                    <li class="font-15 mb-1"><a
                                            href="{{ url('/apps/email/inbox') }}">{{ __('Email') }}</a></li>
                                    <li class="font-15 mb-1"><a
                                            href="{{ url('/apps/file-manager') }}">{{ __('File Manager') }}</a></li>
                                    <li class="font-15 mb-1"><a
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="list-unstyled megamenu-list">
                                    ...
                                    <li class="font-15 mb-1"><a href="{{ url('/pages/faq') }}">{{ __('FAQ') }}</a>
                                    </li>
                                    <li class="font-15 mb-1"><a
    ...
    <ul class="navbar-item flex-row ml-md-auto">
        ...
        <li class="nav-item dropdown user-profile-dropdown">
            <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                ...
                <img src="{{ url('assets/img/logo-1.png') }}" alt="avatar" style="height:39px ;width: 40px; ">
            </a>
            <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                <div class="nav-drop is-account-dropdown">
                    <div class="inner">
                        <div class="nav-drop-header">
                            <span class="text-primary font-15">{{ __('Welcome') }}
                                {{ Str::limit(UcFirst(Auth::User()->name), 5) }} !</span>
                        </div>
                        <div class="nav-drop-body account-items pb-0">
                                    ...
                                    <div class="media-left">
                                        <div class="image">
                                            <img class="rounded-circle avatar-xs"
                                                src="{{ url('assets/img/logo-1.png') }}"
                                                style="height:40px ;width: 45px; " alt="">
                                        </div>
                                    </div>
                                    <div class="media-content ml-3">
                                        <h6 class="font-13 mb-0 strong">{{ UcFirst(Auth::User()->name) }}</h6>
                                        <small>{{ Str::limit(Auth::User()->email, 15) }}</small>
                                    </div>
                            ...
                            {{-- , Auth::User()->id --}}
                            <a class="account-item" href="{{ route('users.change.password', Auth::User()->id) }}">
                                <div class="media align-center">
                                    <div class="icon-wrap">
                                        <i class="las la-user font-20"></i>
                                    </div>
                                    <div class="media-content ml-3">
                                        <h6 class="font-13 mb-0 strong">{{ __('Account Settings') }}</h6>
                                    </div>
                                </div>
                            </a>
