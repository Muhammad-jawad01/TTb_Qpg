    ...
    <div class="login-three">
        <div class="container-fluid login-three-container">
            <div class="main_div_for_login">
                        ...
                        <div class="col-xl-12 col-lg-10 col-md-10">
                            <div class="row">
                                <div class="col-md-8 mx-auto">
                                    {{-- <h4 class="d-flex justify-content-center"><strong>{{ __(' Technical Board peshawar Login') }}</strong></h4> --}}
                                    <h3>
                                        <strong>{{ __(' Technical Board peshawar Login') }}</strong><br>
                                    </h3>
                                    <img src="{{ asset('assets/img/logo.jpg') }}" class="img-fluid " class="mt-3"
                                        alt="">
                                </div>
                            </div>
                            <div class="row">
                ...
                <div class="row mt-4">
                    <div class="col-md-8">
                        <!-- <img src="#" class="img-fluid ml-3" alt=""> -->
